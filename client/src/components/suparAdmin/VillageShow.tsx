...
import { useDeleteVillageMutation, useGetVillagesQuery, useUpdateVillageMutation } from "@/services/villageApi"

const VillageShow = () => {
    const { data, isError, isLoading, refetch } = useGetVillagesQuery()
