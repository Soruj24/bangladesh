...
import { Shield, Fingerprint, KeyRound, Users, UserPlus, ShieldCheck, ChevronRight } from "lucide-react";
...
const workspaceLinks = [
  {
    ...
    description: "Browse everyone registered in the system.",
  },
  {
    to: "/dashboard/admin/add-admin-users",
    icon: UserPlus,
    title: "Add population",
    description: "Register a new person with photo and placement.",
  },
  {
    to: "/dashboard/admin/all-users",
    icon: ShieldCheck,
    title: "Manage accounts",
    description: "Change roles or remove access.",
  },
];
            ...
            <div className="ledger-row">
              ...
              <div>
                ...
                <p className="text-sm font-medium">
                  Manage population records and user accounts.
                </p>
              </div>
            </div>
          </div>
