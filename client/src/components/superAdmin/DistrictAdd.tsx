...
const DistrictAdd = () => {
  ...
  if (loadingDivisions) return <div className="flex items-center gap-2 text-sm text-gray-500"><Loader2 className="h-4 w-4 animate-spin" /> Loading divisions...</div>;

  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
      <div>
        <Label className="text-sm">Select Division</Label>
      ...
      <div>
        <Label htmlFor="dist-name" className="text-sm">Name</Label>
